...
export const DropBoxSearchIcon = () => {
    return (
        <View style={styles.boxWrap3}>
            <Image
                source={require('../../assets/icons/search.png')}
                resizeMode={"contain"}
                style={styles.boxIcons3}
            />
        </View>   
    )
}
...
const styles = StyleSheet.create({
    ...
    boxWrap3 : {
        position:'absolute',top:6,right:10,width:26,height:26,alignItems:'flex-end',zIndex:0
    },
    boxIcons3 : {
