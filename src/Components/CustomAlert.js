        ...
        return(
            <View style={ styles.container }>
                <View style={{height:40}}>
                    <View style={{paddingVertical:5,alignItems:'flex-start',justifyContent:'flex-start'}}>
                        <CustomTextM style={{fontSize:PixelRatio.roundToNearestPixel(DEFAULT_TEXT.fontSize15),color:'#494949'}}>{this.props.screenState.alertTitle}
                        </CustomTextM>
                    </View>
                </View>   
                <View style={{flex:2,marginTop:5,alignItems:'flex-start',justifyContent:'flex-start'}}>
                    <ScrollView>
                        {this.props.screenState.alertBody || <View></View>}
                    </ScrollView>
                </View>
                <View style={{flex:0.5,flexDirection:'row',justifyContent:'flex-end',alignItems:'flex-end',width:'95%',paddingBottom:20}}>
                    ...
                    >
                        <CustomTextM style={{fontSize:PixelRatio.roundToNearestPixel(DEFAULT_TEXT.fontSize13),color:'#2f9afd'}}>OK</CustomTextM>
                    </TouchableOpacity>
                </View>
