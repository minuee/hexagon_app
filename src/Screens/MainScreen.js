        ...
        return(
            ...
            >
                ...
                <Tab.Screen
                    ...
                    options={{    
                        tabBarLabel: ({color})=>this.CustomTabsLabel('구매내역',color),
                        tabBarIcon: ({color}) => (
                ...
                <Tab.Screen
                    ...
                    options={{
                        tabBarLabel: ({color})=>this.CustomTabsLabel('유저관리',color),
                        tabBarIcon: ({color}) => (
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                <Image 
                ...
                <Tab.Screen
                    ...
                    options={{
                        ...
                        tabBarIcon: ({color}) => (
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                <Image 
                                source={color === DEFAULT_COLOR.base_color ? require('../../assets/icons/tab4_on.png') : require('../../assets/icons/tab4_off.png')}
                                    resizeMode={'contain'}
                                    style={Platform.OS === 'ios' ? styles.tabsWrapiOS : styles.tabsWrapAndroid}
                                />
                            </View>
...
const styles = StyleSheet.create({
    ...
    tabsWrapAndroid : {
        width:PixelRatio.roundToNearestPixel(20),height:PixelRatio.roundToNearestPixel(20),marginTop:15
    },
    tabsWrapiOS : {
        width:PixelRatio.roundToNearestPixel(20),height:PixelRatio.roundToNearestPixel(20),marginTop:0
    }
});
...
function mapDispatchToProps(dispatch) {
    return {                
        _fn_UpdateDrawerOpen:(bool)=> {
            dispatch(ActionCreator.fn_UpdateDrawerOpen(bool))
        }
    };
}
