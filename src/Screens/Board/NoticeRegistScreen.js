...
class NoticeRegistScreen extends Component {
    constructor(props) {
        super(props);
    ...
    registData = async() => {
        ...
        if ( !CommonUtil.isEmpty(thumbnail_new.data)  ) {
            ...
            try {            
                const url = DEFAULT_CONSTANTS.apiAdminDomain + '/cms/notice/regist';
                const token = this.props.userToken.apiToken;
                
                let sendData = {
                    title : this.state.formTitle,
                    img_url : !CommonUtil.isEmpty(thumbnail_new.data) ? thumbnail_new.data : null,
...
const styles = StyleSheet.create({
    ...
    calendarTextWrap : {
        flex:1,flexDirection:'row',flexGrow:1,borderWidth:1,borderColor:'#ccc',margin:0,padding:0
    },
    calendarTextLeftWrap : {
        flex:3,padding:5,justifyContent:'center',alignItems:'center'
    },
    calendarTextRightWrap : {
        flex:1,justifyContent:'center',alignItems:'center',backgroundColor:'#e1e1e1',margin:0,padding:0
    },
    betweenWrap : {
...
export default connect(mapStateToProps,mapDispatchToProps)(NoticeRegistScreen);