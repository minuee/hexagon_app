...
class MyModifyScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading : true,
    ...
    async UNSAFE_componentWillMount() {
        console.log('MyModifyScreen',this.props.userToken)
        if ( !CommonUtil.isEmpty(this.props.userToken.member_pk)) {
            this.setState({
                member_pk : this.props.userToken.member_pk,
                formUserID : this.props.userToken.user_id,
                formUserName : this.props.userToken.name,
                formUserTel : CommonFunction.fn_dataDecode(this.props.userToken.phone),
                formUserEmail : CommonFunction.fn_dataDecode(this.props.userToken.email)
            })
        }else{
...
export default connect(mapStateToProps,mapDispatchToProps)(MyModifyScreen);