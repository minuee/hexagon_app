                    ...
                    <View style={styles.mainWrap}>
                        {
                            ...
                            return (
                                <View style={styles.boxWrap2} key={index}>
                                    <TouchableOpacity  style={styles.boxDataWrap1} onPress={()=>this.moveDetail('A',item)}>
                                    ...
                                    </TouchableOpacity>
                                    {
                                        ...
                                        <View style={[styles.boxDataWrap2,{justifyContent:'flex-end'}]}>
                                            <CustomTextR style={styles.dataText}>0원</CustomTextR>
                                        </View>
                                        :
                                        <TouchableOpacity 
                                    ...
                                    {
                                        item.approval === false ?
                                        <View style={styles.boxDataWrap4} >
