      ...
      <Animated.View style={[styles.box, this.props.style, {height: this.state.animation}]}>
        ...
        >
          <View style={this.props.titleContainer ? this.props.titleContainer  :styles.titleContainer}>
            <CustomTextB style={this.props.labelStyle ? this.props.labelStyle : styles.label}>{this.props.label}</CustomTextB>
            {this.props.value ? <CustomTextB style={styles.value}>{this.props.value}</CustomTextB> : null}
            <Icon
              name={icon}
