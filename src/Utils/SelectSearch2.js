...
import { Text, StyleSheet, TouchableOpacity, View, FlatList, Button,TextInput, Dimensions, Animated, Platform, Alert, PixelRatio } from 'react-native';
...
// create a component
class SelectSearch2 extends Component {
    static defaultProps = {
    ...
    onItemSelected = (item, isSelectSingle) => {
        ...
        //console.log('isSelectSingle', data)
    ...
    onItemRemoved = (item, isSelectSingle) => {
    }
            ...
            <TouchableOpacity
                ...
                onPress={() => {
                    if(!item.checked) {
                        ...
                        this.onItemRemoved(item, isSelectSingle)
                    }
                }}
                activeOpacity={0.7}
